...
import in.innovateria.hindishayari.Activities.MainActivity;
import in.innovateria.hindishayari.Models.ShayariCategoryModel;
...
public class ShayariCategoryAdapter extends RecyclerView.Adapter<ShayariCategoryAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if(Objects.equals(list.get(position).getName(), "SoullessBoy's Special"))
            holder.emojiView.setBackgroundResource(R.drawable.soullessboy);
        else if (Objects.equals(list.get(position).getName(), "Love Shayari"))
            holder.emojiView.setBackgroundResource(R.drawable.heart);
        else
